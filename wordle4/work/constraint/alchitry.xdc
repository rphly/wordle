...
set_property PACKAGE_PIN F5 [get_ports {top_display1}]
set_property IOSTANDARD LVCMOS33 [get_ports {top_display1}]
set_property PACKAGE_PIN E5 [get_ports {bot_display1}]
set_property IOSTANDARD LVCMOS33 [get_ports {bot_display1}]
