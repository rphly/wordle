...
module regfile_backup_4 (
  ...
  reg [1:0] M_guess_ctr_d, M_guess_ctr_q = 1'h0;
  ...
  always @* begin
    ...
    case (M_guess_ctr_q)
      1'h0: begin
        display_top[0+6-:7] = M_guess_1_letter_1_q;
        display_top[7+6-:7] = M_guess_1_letter_2_q;
        display_top[14+6-:7] = M_guess_1_letter_3_q;
        display_top[21+6-:7] = M_guess_1_letter_4_q;
      end
      1'h1: begin
        display_top[0+6-:7] = M_guess_2_letter_1_q;
        display_top[7+6-:7] = M_guess_2_letter_2_q;
        display_top[14+6-:7] = M_guess_2_letter_3_q;
        display_top[21+6-:7] = M_guess_2_letter_4_q;
      end
      2'h2: begin
        display_top[0+6-:7] = M_guess_3_letter_1_q;
        display_top[7+6-:7] = M_guess_3_letter_2_q;
        display_top[14+6-:7] = M_guess_3_letter_3_q;
        display_top[21+6-:7] = M_guess_3_letter_4_q;
      end
      2'h3: begin
        display_top[0+6-:7] = M_guess_4_letter_1_q;
        display_top[7+6-:7] = M_guess_4_letter_2_q;
        display_top[14+6-:7] = M_guess_4_letter_3_q;
        display_top[21+6-:7] = M_guess_4_letter_4_q;
      end
      default: begin
        display_top[0+6-:7] = 1'h0;
        display_top[7+6-:7] = 1'h0;
        display_top[14+6-:7] = 1'h0;
        display_top[21+6-:7] = 1'h0;
        if (recall) begin
