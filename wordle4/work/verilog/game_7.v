...
module game_7 (
    ...
    output reg [10:0] correct_word_index
  );
  ...
  localparam OKA_MODE = 6'h24;
  
  localparam SHOW_GUESS_ONE = 5'h01;
  
  localparam SHOW_GUESS_TWO = 5'h04;
  
  localparam SHOW_GUESS_THREE = 5'h08;
  
  localparam SHOW_GUESS_FOUR = 5'h0c;
    ...
    if (rst) begin
      ...
      case (M_game_fsm_q)
        ...
        RESET_TOP_DISPLAY_game_fsm: begin
          top_matrix_controller_update = 3'h5;
          top_matrix1_letter_address = 5'h00;
          top_matrix2_letter_address = 5'h00;
          top_matrix3_letter_address = 5'h00;
          top_matrix4_letter_address = 5'h00;
        ...
        RESET_BOTTOM_DISPLAY_game_fsm: begin
          ...
          if (regfile_out_a == 1'h0 && regfile_out_b == 1'h0) begin
            top_matrix_controller_update = 4'h9;
        ...
        SET_CORRECT_WORD_game_fsm: begin
          ...
          if (alu_out == 2'h1) begin
            regfile_data = random_number_out[0+10-:11] - 7'h59;
          end else begin
            regfile_data = random_number_out[0+10-:11];
          end
          regfile_we = 1'h1;
          regfile_ra = 6'h23;
        ...
        SHOW_GUESS_ONE_game_fsm: begin
          regfile_ra = 7'h40;
          regfile_rb = 8'h41;
          top_matrix_controller_update = 4'hc;
          top_matrix1_letter_address = regfile_out_a;
          top_matrix2_letter_address = regfile_out_b;
          M_game_fsm_d = SHOW_GUESS_ONE_2_game_fsm;
        end
        SHOW_GUESS_ONE_2_game_fsm: begin
          regfile_ra = 8'h42;
          regfile_rb = 8'h43;
          top_matrix_controller_update = 4'he;
          top_matrix3_letter_address = regfile_out_a;
          top_matrix4_letter_address = regfile_out_b;
          M_game_fsm_d = IDLE_game_fsm;
        end
        SHOW_GUESS_TWO_game_fsm: begin
          regfile_ra = 5'h04;
          regfile_rb = 6'h05;
          top_matrix_controller_update = 4'hc;
          top_matrix1_letter_address = regfile_out_a;
          top_matrix2_letter_address = regfile_out_b;
          M_game_fsm_d = SHOW_GUESS_TWO_2_game_fsm;
        end
        SHOW_GUESS_TWO_2_game_fsm: begin
          regfile_ra = 6'h06;
          regfile_rb = 6'h07;
          top_matrix_controller_update = 4'he;
          top_matrix3_letter_address = regfile_out_a;
        ...
        SHOW_GUESS_THREE_game_fsm: begin
          regfile_ra = 5'h08;
          regfile_rb = 6'h09;
          top_matrix_controller_update = 4'hc;
          top_matrix1_letter_address = regfile_out_a;
          top_matrix2_letter_address = regfile_out_b;
          M_game_fsm_d = SHOW_GUESS_THREE_2_game_fsm;
        end
        SHOW_GUESS_THREE_2_game_fsm: begin
          regfile_ra = 6'h0a;
          regfile_rb = 6'h0b;
          top_matrix_controller_update = 4'he;
          top_matrix3_letter_address = regfile_out_a;
        ...
        SHOW_GUESS_FOUR_game_fsm: begin
          regfile_ra = 5'h0c;
          regfile_rb = 6'h0d;
          top_matrix_controller_update = 4'hc;
          top_matrix1_letter_address = regfile_out_a;
          top_matrix2_letter_address = regfile_out_b;
          M_game_fsm_d = SHOW_GUESS_FOUR_2_game_fsm;
        end
        SHOW_GUESS_FOUR_2_game_fsm: begin
          regfile_ra = 6'h0e;
          regfile_rb = 6'h0f;
          top_matrix_controller_update = 4'he;
          top_matrix3_letter_address = regfile_out_a;
